...
About : My Project Name Is OFS. It is a Web Application . I Build By using Java, Jdbc, Servlets, JSsP & MYSQL. 
        It Handles Features Like Food Ordering, USer Login, Restart lIstings & Cart.
-----------------------------------------------------------------------------------------------------------
